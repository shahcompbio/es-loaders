...
class ElasticsearchClient():
    ...
    def load_record(self, record, index, doc, id):
        ...
        self.es.index(index=index, doc_type=doc, id=id, body=record)
    ...
    def load_published_dashboard_record(self, jira_id, description='', title=''):
        ...
        self.load_record(record, index="published_dashboards", doc="published_dashboards", id=jira_id)
